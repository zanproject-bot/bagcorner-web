...
function Home() {
  ...
  return (
    <div className="relative min-h-screen text-foreground overflow-hidden">
      ...
      <header className="max-w-7xl mx-auto px-6 lg:px-10 pt-6 lg:pt-8 flex items-center justify-between">
        <a href="/" className="text-2xl lg:text-3xl font-display font-semibold tracking-tight">
      ...
      <section id="koleksi" className="max-w-7xl mx-auto px-6 lg:px-10 mt-16 lg:mt-24 pb-16">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
          ...
          <div className="w-full lg:w-[30%] lg:min-w-[30%] flex flex-col items-center text-center">
            {/* Header text moved out of carousel, aligned with 'Rating Kepuasan Pelanggan' */}
